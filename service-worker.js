...
const ASSETS=['./','./index.html','./app.css?v=24','./v26-overrides.css?v=26','./app-v24.js?v=24','./app-v26-patch.js?v=26','./manifest.webmanifest?v=26','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
