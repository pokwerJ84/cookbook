const CACHE='japan-protein-cookbook-v12';
const ASSETS=['./','./index.html','./app.css','./app.js','./app-v12.js','./manifest.webmanifest','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
