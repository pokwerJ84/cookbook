const CACHE='japan-protein-cookbook-v16';
const ASSETS=['./','./index.html','./app.css','./app.js','./app-v14.js','./app-v16.js','./manifest.webmanifest','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
